  ...
  return (
    <div>
      ...
      <div className="lg:w-[50%] p-4 mx-auto space-y-4">
        ...
        <p className={cn(jost.className)}>
          To know what’s going to happen in the markets in the near-future with
      ...
      <div className="lg:w-[50%] p-4 mx-auto space-y-4">
        ...
        >
          Here’s a Detailed Breakdown of <br /> Everything You’ll Get Right Now…
        </h1>
        ...
        <p className={cn(jost.className)}>
          ...
          interpreting An-E’s findings and issuing two new stock recommendations
          every month.{" "}
        </p>
        <p className={cn(jost.className)}>
        ...
        <p className={cn(jost.className)}>
          ...
          forecasts, updated daily, for nearly 3,000 stocks, funds, and ETFs...
          you’ll have many stocks to choose from...
        </p>
        <p className={cn(jost.className)}>
      ...
      <div className="lg:w-[50%] p-4 mx-auto space-y-4">
        ...
        <p className={cn(jost.className)}>
          ...
          Street caliber, A.I.-driven stock forecasting system — the only one of
          its kind we know of on the market…
        </p>
        ...
        <p className={cn(jost.className)}>
          ...
          learning to predict stock prices with incredible accuracy, so you can
          make massive gains and avoid big losses month after month… then I
          encourage you to become a member of Predictive Alpha today.
        </p>
        <p className={cn(jost.className)}>
